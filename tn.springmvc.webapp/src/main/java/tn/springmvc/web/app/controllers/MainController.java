package tn.springmvc.web.app.controllers;
...
import tn.springmvc.web.exceptions.FailureResponse;
...
public class MainController {
	 ...
	 * 
	 * @param request
	 * @return used to handle 500 internal server errors. see WEB-INF/web.xml for more details
	 */
	@ResponseBody
